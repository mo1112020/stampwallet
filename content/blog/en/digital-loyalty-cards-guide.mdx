...
3. **The pass sits in their wallet**, visible whenever they open the app, and surfaces on their lock screen when they're near your store if location is configured.
...
That's the model WalletOS is built around: stamp cards, points, and full reward journeys, all delivered as real Apple Wallet and Google Wallet passes, with a scan flow built for a busy counter rather than a back office. If you want to see what a pass looks like from the customer's side before setting anything up, the [features overview](/en/features/wallet) walks through it, or read more on [how Apple Wallet & Google Wallet loyalty cards work](/en/blog/wallet-loyalty-cards-no-app-download) with no app download at all. If your business is more about an ongoing relationship than a single purchase, [reward journey / tiered loyalty programs](/en/blog/reward-journey-tiered-loyalty-explained) cover the third model WalletOS supports.

If you run a business in one of these categories specifically, we've written a more detailed guide for it: [car wash loyalty programs](/en/blog/car-wash-loyalty-program), [pet grooming loyalty card app](/en/blog/pet-grooming-loyalty-card), [clinic & pharmacy loyalty program](/en/blog/clinic-pharmacy-loyalty-program), and [independent hotel loyalty program](/en/blog/independent-hotel-loyalty-program). And once a program is running, [wallet push notifications for GCC merchants](/en/blog/wallet-push-notifications-gcc-merchants) covers the highest-open-rate channel most merchants aren't using yet, and [WhatsApp Business + wallet loyalty marketing](/en/blog/whatsapp-business-wallet-loyalty-gcc) covers a practical way to combine two tools you're likely already using.

For merchants in the GCC specifically: [Ramadan & Eid wallet loyalty campaigns](/en/blog/ramadan-eid-loyalty-wallet-campaigns) covers the season's biggest opportunity, and native Arabic guides are available for [حملات ولاء رمضان والعيد](/ar/blog/ramadan-eid-loyalty-arabic), [واتساب بزنس ومحفظة الولاء الرقمية](/ar/blog/whatsapp-wallet-loyalty-arabic), [برنامج ولاء غسيل السيارات (عربي)](/ar/blog/car-wash-loyalty-arabic), and [برامج ولاء الفنادق المستقلة](/ar/blog/independent-hotel-loyalty-arabic).
