...
WalletOS runs all three models, stamp cards, points, and full reward journeys, as real Apple Wallet and Google Wallet passes, so the choice is about what fits your customers, not what the software happens to support. If you're still deciding, the [industries page](/en/industries) breaks down which model tends to fit which type of business, or you can see how each one looks from the customer's side on the [features overview](/en/features/programs).
