...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "site.infrastructure" });
  return buildPageMetadata({ locale, path: "infrastructure", title: t("title"), description: t("description") });
}
