    ...
    <main>
      <section className="relative min-h-[100dvh] overflow-hidden bg-white">
        <div className="mx-auto flex min-h-[100dvh] max-w-6xl flex-col items-center gap-10 px-6 pb-16 pt-28 md:gap-12 lg:flex-row lg:gap-14 lg:pb-20 lg:pt-28 rtl:lg:flex-row-reverse">
          <div className="mx-auto h-[500px] w-[283px] shrink-0 lg:mx-0">
          ...
          <div className="relative flex w-full flex-1 flex-col justify-center lg:max-w-xl">
      ...
      <section className="px-6 py-24 md:py-32">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-4xl font-bold tracking-tight md:text-5xl">{t("pocketTitle")}</h2>
      ...
      <section className="border-y border-[var(--line)] bg-[var(--surface-2)] px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <h2 className="max-w-md text-3xl font-bold tracking-tight md:text-4xl">{t("exploreTitle")}</h2>
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            <Link
              href={`/${locale}/features`}
              className="rounded-[24px] border border-[var(--line)] bg-white p-7 hover:border-[var(--line-strong)]"
            >
              <h3 className="text-xl font-semibold">{t("exploreFeatures")}</h3>
            ...
            <Link
              ...
              className="rounded-[24px] border border-[var(--line)] bg-white p-7 hover:border-[var(--line-strong)]"
            >
              <h3 className="text-xl font-semibold">{t("exploreIndustries")}</h3>
            ...
            <Link
              ...
              className="rounded-[24px] border border-[var(--line)] bg-white p-7 hover:border-[var(--line-strong)]"
            >
              <h3 className="text-xl font-semibold">{t("explorePricing")}</h3>
