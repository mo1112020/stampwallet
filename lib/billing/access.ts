...
/** Paddle subscription statuses that currently grant paid access.
 * `past_due` is included deliberately — Paddle is mid-dunning-retry, not
 ...
 * not grant access. A pending `scheduled_change` (see merchants.
